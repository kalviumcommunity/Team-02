...
export const PlannerView = () => {
  ...
  const approvalQueue = requests.filter(r => {
    ...
    return isPending && matchesSearch && matchesRisk;
  }).sort((a, b) => {
    // Sort by Urgency first, then Critical Risk
  ...
  const handleFullApprove = () => {
    ...
    approveRequest(decisionReq.id, approvedQtyMap, decisionReason || 'Full quantity approved by planner.');
    setDecisionReq(null);
  };
      ...
      <div className="card-panel">
        <div className="panel-header">
          <div className="panel-title">
            ...
            <span>Prioritized Request Queue</span>
          </div>
                ...
                approvalQueue.map(req => {
                  ...
                  return (
                    <tr key={req.id}>
                      ...
                      <td>
                        <div style={{ fontWeight: 700, color: prod.warehouseAvailable > 50 ? 'var(--risk-low)' : 'var(--risk-high)' }}>
                          {prod.warehouseAvailable || 150} Units
                        </div>
                  ...
                  <div key={line.id} style={{ 
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                      ...
                      <div style={{ fontSize: '0.8rem', color: 'var(--risk-low)' }}>
                        WH Available: {prod.warehouseAvailable || 120} Units
                      </div>
                    </div>
